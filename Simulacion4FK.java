...
public class Simulacion4FK {
    ...
    void simulacion() {
        int resultado;
        resultado = JOptionPane.showConfirmDialog(null, "Desea ejecutar la simulacion");
        if (resultado == JOptionPane.YES_OPTION) {
            for (int simulaciones = 0; simulaciones < 10000; simulaciones++) {
                turno();
            }
            JOptionPane.showMessageDialog(null, "Numero de veces que se obtiene el four of kind  en 10.000 jugadas "+for_of_kind);
